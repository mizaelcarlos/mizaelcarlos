...
<div style="display: inline_block"><br>
  <img src="https://skillicons.dev/icons?i=vscode,php,laravel,html,css,js,jquery,bootstrap,git,github,bitbucket,gitlab,gitflow,aws,python,oracle,mysql,postgresql,sql server&theme=dark" />
 </div>
<hr>
